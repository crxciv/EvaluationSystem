<?php
    ...
    if(isset($_GET['delete'])){
      ...
      header('location:admin_edit_question_prog.php');
    }
    if(isset($_POST['edit'])){
      ...
      <table>
        <?php 
          ...
          <tr>
            ...
            <td></td>
            <td><a href="admin_edit_question_prog.php?delete=<?php echo $fetch_questions ['id']; ?>;" name="delete" onclick="return confirm('Delete this message?');">DELETE</a> </td>
            <td><a href="admin_edit_question_prog.php?edit=<?php echo $fetch_questions ['id']; ?>;" name="edit">edit</a> </td>
          </tr>
      <?php 
        }
          }else{
