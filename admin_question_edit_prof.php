    ...
    <div class="containers">
      ...
      <div class="main">
        ...
        <div class="div-container student-div d-flex">
          ...
          <h3>Edit Professor Evaluation</h3>
        </div>
        ...
        <h3>Professor Evalutaion</h3>
          <table class="table-bordered table">
            ...
            <tr>
                ...
                <td><a class="btn btn-outline-success" href="admin_question_edit_prof.php?edit=<?php echo $fetch_professor ['id']; ?>;" name="edit">EDIT</a></td>
              </tr>
            <?php 
              }
                  }else{
            ...
            <thead>
                <tr>
                    <th colspan="6">Effective Planning</th>
                </tr>
            </thead>
            <tbody>
            <?php 
            ...
            <thead>
                <tr>
                    <th colspan="6">Classroom Environment</th>
                </tr>
            </thead>
            <tbody>
            <?php 
