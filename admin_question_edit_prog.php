                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-sm-12 ">
                            ...
                            <select class="form-control" name="update-criteria" id="dept" required>
                                ...
                                <option value=" satisfaction">Teaching Techniques</option>
                                <option value=" impact">Effective Planning</option>
                                <option value=" implementation">Classroom Environment</option>
                            </select>
                        </div>
        ...
        <h3>Program Evalutaion</h3>
          <table class="table-bordered table">
            ...
            <tr>
                ...
                <td><a class="btn btn-outline-success" href="admin_question_edit_prog.php?edit=<?php echo $fetch_program ['id']; ?>;" name="edit">EDIT</a></td>
              </tr>
            <?php 
              }
                  }else{
