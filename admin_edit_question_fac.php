<?php
    ...
    if(isset($_GET['delete'])){
      ...
      header('location:admin_edit_question_fac.php');
    }
    if(isset($_POST['edit'])){
      ...
      <table>
        <?php 
          ...
          <tr>
            ...
            <td></td>
            <td><a href="admin_edit_question_fac.php?delete=<?php echo $fetch_questions ['id']; ?>;" name="delete" onclick="return confirm('Delete this message?');">DELETE</a> </td>
            <td><a href="admin_edit_question_fac.php?edit=<?php echo $fetch_questions ['id']; ?>;" name="edit">edit</a> </td>
          </tr>
      <?php 
        }
          }else{
