<?php
    ...
    if(isset($_GET['delete'])){
        ...
        header('location:admin_student_delete.php');
    }
          ...
          <table class="student-view-table table-bordered table">
            ...
            ?>
                <tr>
                    ...
                    <td><a class="btn btn-outline-danger" href="admin_student_delete.php?delete=<?php echo $fetch_user ['id']; ?>;" name="delete" onclick="return confirm('Delete this message?');" >Delete</a></td>
                </tr>
            <?php 
              }
                  }else{
